...
public class FragmentNoticia1 extends Fragment {
    View view;
    private RelativeLayout btnr_regresar;
    private  MainActivity mainActivity;
    private  PrincipalFragment principalFragment;

    public FragmentNoticia1() {
    }
    public FragmentNoticia1(MainActivity mainActivity){
        this.mainActivity = mainActivity;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstacianeStatus) {
        view = inflater.inflate(R.layout.fragment_noticia1, container, false);
        initVariables();
        initEvents();
        return view;
    }
